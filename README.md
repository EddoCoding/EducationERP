EducationERP - Программа для автоматизирования процессов в высших учебных заведениях, переписывается на нормальный MVVM с предыдущего проекта сделаного для диплома. 
